...
var (
	...
	// docker run -d -e MYSQL_ROOT_PASSWORD=1234 -e MYSQL_DATABASE=golang2017 -v $(pwd):/docker-entrypoint-initdb.d -p 3306:3306 mysql:5.7
	DSN = "root:1234@tcp(0.0.0.0:3306)/golang2017?charset=utf8"
